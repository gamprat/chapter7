...
export const CorouselItem = (props) => {
  return (
     ...
     <div alt="image 1" className=" bg-cover h-[563px] w-screen" style={{ backgroundImage: `linear-gradient(to left, transparent, black), url('https://image.tmdb.org/t/p/original${props.backdrop_path}')` }}  >
        <div className='flex'>
