                ...
                <div className='relative h-[500px] flex flex-col m-4 space-y-8 bg-white bg-opacity-90 shadow-2xl rounded-xl md:flex-row md:space-y-0 '>
                    ...
                    <div className='py-1'>
                        ...
                        <div className='items-center flex justify-end'>
                            <input onChange={handleInput} id='name' className='w-full p-1 border border-gray-300 rounded-md caret-black placeholder:font-light placeholder:text-gray-700' type="text" />
                    ...
                    <div className='py-1'>
                        ...
                        <div className='items-center flex justify-end'>
                            <input onChange={handleInput} id='lastname' className='w-full p-1 border border-gray-300 rounded-md caret-black placeholder:font-light placeholder:text-gray-700' type="text" />
                            <span className='absolute mr-3'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                            </svg>
                            </span>
                    ...
                    <div className='py-1'>
                        ...
                        <div className='items-center flex justify-end'>
                            <input onChange={handleInput} id='email' className='w-full p-1 border border-gray-300 rounded-md caret-black placeholder:font-light placeholder:text-gray-700' type="email" />
                            <span className='absolute mr-3'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    ...
                    <div className='py-1'>
                        ...
                        <div className='items-center flex justify-end'>
                            <input onChange={handleInput} id='password' className='w-full p-1 border border-gray-300 rounded-md caret-black placeholder:font-light placeholder:text-gray-700' type={(open === false) ? 'password' : 'text'} />
                    ...
                    <div className='py-1'>
                        ...
                        <div className='items-center flex justify-end'>
                            <input onChange={handleInput} id='password_confirmation' className='w-full p-1 border border-gray-300 rounded-md caret-black placeholder:font-light placeholder:text-gray-700' type={(open === false) ? 'password' : 'text'}/>
                            <span className='absolute mr-3 text-gray-500'>{(open === false ) ? <AiFillEyeInvisible onClick={toggle}/> : <AiFillEye onClick={toggle}/>}</span>
                        </div>
                    </div>
